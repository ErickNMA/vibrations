...
%TCIDATA{LastRevised=Mon Oct 08 12:02:01 2001}
...
\begin{NFThesistitle}
Estudo do Conforto de um autom\'{o}vel utilizando a paranormalidade comparada
\end{NFThesistitle}
...
Frente a um mercado cada vez mais competitivo, as montadoras instaladas no pa%
\'{i}s procuram fazer com que os autom\'{o}veis nacionais atinjam n\'{i}veis
de qualidade equiparados aos n\'{i}veis dos produtos comercializados na
Europa e EUA.
...
Dentre os v\'{a}rios componentes de um sistema de suspens\~{a}o de um autom%
\'{o}vel, a barra estabilizadora cumpre um importante papel no ''ajuste''
das suspens\~{o}es. O estudo da influ\^{e}ncia da barra estabilizadora em par%
\^{a}metros de conforto, ou seja, um estudo das v\'{a}rias freq\"{u}\^{e}%
ncias de vibra\c{c}\~{a}o, provenientes da pista, que atingem os ocupantes
do ve\'{i}culo, possibilitar\'{a} identificar qual a influ\^{e}ncia da
rigidez e da forma da barra estabilizadora no conforto de um autom\'{o}vel.
...
A rigor o sistema de suspens\~{a}o MacPherson, apresentado na figura \ref
...
wishbone'' foi substitu\'{i}do por um ponto de giro na torre do amortecedor.
A chamada torre do amortecedor recebe esse nome porque a extremidade da
haste do amortecedor e a mola helicoidal s\~{a}o alojadas no seu interior,
figura \ref{McPh_show}.
...
As vantagens do sistema de suspens\~{a}o MacPherson s\~{a}o as seguintes:
...
amortecedor e mola \`{a} carroceria um batente de borracha e uma estrutura
...
coincidente com a linha de a\c{c}\~{a}o do amortecedor, figura xx. Na equa%
\c{c}\~{a}o \ref{eq.6.1}, a medida que $s$ aumenta $F_{E}$ diminui, ou na
equa\c{c}\~{a}o \ref{eq.4.1} \`{a} medida que s aumenta, a diminui e em
conseq\"{u}\^{e}ncia o seu seno, desta forma $F_{E}$ tamb\'{e}m diminui.
...
Fe atua no amortecedor j\'{a} que a mola s\'{o} pega carga no sentido do seu
eixo.\bigskip
...
\~{a}o utilizando bra\c{c}os arrastados interconectados\footnote{%
...
porte. Segundo Bastow \cite{Bastow}, o Volkswagen Golf foi o pioneiro na
...
rodas com o movimento da suspens\~{a}o, pequena altera\c{c}\~{a}o do \^{a}%
ngulo de camber, al\'{e}m de possuir boa posi\c{c}\~{a}o dos polos de 
\textit{Pitch}, o que reduz a tend\^{e}ncia da subida da traseira durante a
frenagem . Os principais pontos fracos desse sistema de suspens\~{a}o s\~{a}%
o as elevadas tens\~{o}es cisalhantes e de tor\c{c}\~{a}o a que est\~{a}o
sujeitos os elementos da suspens\~{a}o pr\'{o}ximos a regi\~{a}o da solda
entre a viga transversal e os bra\c{c}os oscilantes, o que limita a utiliza%
\c{c}\~{a}o desse sistema em utilit\'{a}rios onde geralmente as cargas a que
se sujeita o sistema de suspens\~{a}o s\~{a}o maiores. Segundo Reimpell \cite
{Reimpell} e Satchell \cite{Satchell}, esse sistema de suspens\~{a}o
apresenta uma leve tend\^{e}ncia ao sobre-ester\c{c}amento\ na presen\c{c}a
de for\c{c}as laterais mais intensas, embora essa tend\^{e}ncia seja
normalmente controlada com a utiliza\c{c}\~{a}o de buchas de borracha com
rigidezas diferenciadas\ nas dire\c{c}\~{o}es horizontais e verticais ou a
utiliza\c{c}\~{a}o de barras transversais do tipo ''\textit{Panhard}''.

\bigskip Do ponto de vista de projeto e ajuste da suspens\~{a}o, a grande
vantagem \'{e} o reduzido n\'{u}mero de caminhos de carga existentes para a
rea\c{c}\~{a}o na carroceria dos esfor\c{c}os provenientes das rodas.\
Tipicamente, as duas buchas transmitem para a carroceria todas as cargas
laterais e longitudinais enquanto as cargas verticais s\~{a}o absorvidas
parte pelas molas e parte pelas pr\'{o}prias buchas.
...
controla os momentos fletores do bra\c{c}o arrastado, enquanto a sua posi%
\c{c}\~{a}o transversal, afeta os momentos longitudinais dos mesmos. Um bom
exemplo de diferentes configura\c{c}\~{o}es do sistema de bra\c{c}os
arrastados interconectados est\'{a} na compara\c{c}\~{a}o das posi\c{c}\~{o}%
es das molas, buchas e amortecedores das suspens\~{o}es dos modelos de m\'{e}%
dio porte das montadoras FIAT, GM e Volkswagen.
...
momentos fletores longitudinais e verticais com um m\'{i}nimo de deflex\~{o}%
es e ao mesmo tempo permitir grandes deforma\c{c}\~{o}es quando sujeita a
esfor\c{c}os de tor\c{c}\~{a}o. Para cumprir esses requisitos utilizam-se
normalmente perfis abertos que possuem grandes momentos de in\'{e}rcia \ e
baixa rigidez \ torcional. Por\'{e}m a utiliza\c{c}\~{a}o de se\c{c}\~{o}es
transversais n\~{a}o circulares para vigas sujeitas \`{a} tor\c{c}\~{a}o
acarreta no aparecimento de \textit{warping} \footnote{%
...
\c{c}\~{a}o. Saint-Venant mostrou que quando uma barra n\~{a}o circular \'{e}
torcida, a se\c{c}\~{a}o transversal que era planar antes da tor\c{c}\~{a}o n%
\~{a}o mais permanecia planar ap\'{o}s a tor\c{c}\~{a}o.} o que faz com que
...
Do ponto de vista cinem\'{a}tico a posi\c{c}\~{a}o da viga em rela\c{c}\~{a}%
o ao ponto de pivotamento da suspens\~{a}o na carroceria possue grande
...
Quando a viga \'{e} montada nessa posi\c{c}\~{a}o e a carroceria do ve\'{i}%
culo rola, por exemplo ao realizar uma curva, o \'{u}nico carregamento a que
est\'{a} sujeita a viga \'{e} a tor\c{c}\~{a}o pura.
...
\c{c}\~{a}o para a correspond\^{e}ncia com o sistema \ por Bra\c{c}os Obl%
\'{i}quos Arrastados.
...
As molas a ar e a g\'{a}s s\~{a}o bastante utilizadas em \^{o}nibus e caminh%
\~{o}es, principalmente pela pouca varia\c{c}\~{a}o da freq\"{u}\^{e}ncia
natural devido a altera\c{c}\~{a}o da carga e sua habilidade em manter o
chassis a uma altura constante. Alguns autom\'{o}veis de passeio topo de
linha utilizam esse tipo de mola, por\'{e}m o seu alto custo de fabrica\c{c}%
\~{a}o e manuten\c{c}\~{a}o restringiram a sua utiliza\c{c}\~{a}o a autom%
\'{o}veis de alto padr\~{a}o.
...
principalmente ao espa\c{c}o que ocupa o sistema e ao atrito consider\'{a}%
vel existente entre as l\^{a}minas.
...
A configura\c{c}\~{a}o mais comum s\~{a}o as cil\'{i}ndricas de passo e di%
\^{a}metro do fio constantes. Para essa configura\c{c}\~{a}o a sua rigidez
...
\bigskip Os amortecedores telesc\'{o}picos de tubo duplo, ver figura \ref
{amortecedor}, se caracterizam por uma c\^{a}mara de trabalho A, onde
trabalha um \^{e}mbolo 1 e sua haste 6, por uma c\^{a}mara de equaliza\c{c}%
\~{a}o C, por uma v\'{a}lvula inferior 4, uma guia para a haste do \^{e}%
mbolo 8 e o seu selo 5.
...
amortecedor se aproximam, o pist\~{a}o 1 se move para baixo e parte do \'{o}%
leo da c\^{a}mara flui atrav\'{e}s da v\'{a}lvula II para a parte A. A outra
parte do \'{o}leo, que corresponde ao volume deslocado pelo \^{e}mbolo,
passa atrav\'{e}s da v\'{a}lvula IV e vai para a c\^{a}mara de equaliza\c{c}%
\~{a}o. Durante a compress\~{a}o a maior parcela do amortecimento
proporcionado pelo amortecedor se deve \`{a} passagem de \'{o}leo pela v\'{a}%
lvula IV.
...
As caracter\'{i}sticas dos amortecedores podem ser apresentadas em dois gr%
\'{a}ficos diferentes; o diagrama de amortecimento que apresenta a for\c{c}a
de amortecimento versus o deslocamento da haste e a curva de amortecimento
...
tipos t\'{i}picos de diagramas e curvas de amortecimento, bem como as equa%
\c{c}\~{o}es que representam cada curva de amortecimento.
...
seja proporcional ao quadrado da velocidade, ver (FIGURA XXX-A), resultando
na curva A da figura. A curva A+B do gr\'{a}fico \'{e} conseguida com a
abertura de um orif\'{i}cio de maior di\^{a}metro em paralelo com o canal
anterior, e com a adi\c{c}\~{a}o de uma v\'{a}lvula de abertura progressiva
pode-se ajustar as curvas de forma a obter uma boa transi\c{c}\~{a}o como a
mostrada no est\'{a}gio 2 da figura (XXX).

Finalmente as curvas finais de amortecimento s\~{a}o ajustadas com os
batentes de borracha instalados dentro dos amortecedores, tanto para compress%
\~{a}o quanto para a disten\c{c}\~{a}o do mesmo. Quando as for\c{c}as a que
est\'{a} sujeito um amortecedor n\~{a}o podem mais ser absorvidas
...
A barra estabilizadora tem como principal fun\c{c}\~{a}o reduzir a inclina%
\c{c}\~{a}o da carroceria durante as curvas e influenciar as caracter\'{i}%
sticas de sub e sobre-ester\c{c}amento, alterando a raz\~{a}o entre as
rigidezas das suspens\~{o}es dianteiras e traseiras \cite{Gillespie}.

A utiliza\c{c}\~{a}o de buchas nos terminais das barras estabilizadoras e
nos mancais pode reduzir em at\'{e} $30\%$ as for\c{c}as \ envolvidas no seu
funcionamento \cite{Spring Manual}.
...
rotativas (conjunto rodas/pneus/montantes), motor e sistemas de transmiss%
\~{a}o. Essas vibra\c{c}\~{o}es s\~{a}o percebidas pelos ocupantes do ve\'{i}%
culo pelo tato, audi\c{c}\~{a}o e vis\~{a}o. Alguns autores estabelecem uma
divis\~{a}o bem definida entre as v\'{a}rias freq\"{u}\^{e}ncias de vibra%
\c{c}\~{a}o experimentadas pelos ocupantes de autom\'{o}veis. Para autores
como Gillespe\cite{Gillespie} a divis\~{a}o \'{e} a seguinte:
...
Justifica-se essa divis\~{a}o do ponto de vista dos limites de audi\c{c}\~{a}%
o do ser humano, j\'{a} que o limite inferior da faixa de freq\"{u}\^{e}ncia
aud\'{i}vel \'{e} aproximadamente 25Hz. Embora a divis\~{a}o te\'{o}rica
seja clara \'{e} dif\'{i}cil considerar uma ou outra separadamente, pois
normalmente as duas se apresentam simultaneamente, o ru\'{i}do (NOISE) est%
\'{a} presente normalmente quando as baixas freq\"{u}\^{e}ncias s\~{a}o
evitadas.

Em outras publica\c{c}\~{o}es o espectro de freq\"{u}\^{e}ncias que
corresponde a faixa mais importante para o estudo do conforto de autom\'{o}%
veis est\'{a} compreendido em uma faixa um pouco diferente da citada acima.
De acordo com Reimpell,\cite{Reimpell} os ocupantes de um autom\'{o}vel est%
\~{a}o sujeitos a uma combina\c{c}\~{a}o de acelera\c{c}\~{o}es e vibra\c{c}%
\~{o}es mec\^{a}nicas que se apresentam em uma faixa bem ampla de freq\"{u}%
\^{e}ncia. A faixa de freq\"{u}\^{e}ncia considerada cr\'{i}tica para o
estudo de conforto de um autom\'{o}vel est\'{a} entre 1 e 80 Hz. Dentro
dessa faixa de freq\"{u}\^{e}ncia tida como mais cr\'{i}tica ainda \'{e}
sugerida uma separa\c{c}\~{a}o em RIDE\ ou SPRINGING COMFORT que engloba a
faixa entre 1 e 4 Hz e ROAD\ HARSHNESS que corresponde a freq\"{u}\^{e}ncias
acima de 4Hz. A separa\c{c}\~{a}o das faixas de freq\"{u}\^{e}ncia \'{e}
importante pois as freq\"{u}\^{e}ncias s\~{a}o percebidas de forma diferente
pelo corpo humano e al\'{e}m disso torna mais f\'{a}cil a distin\c{c}\~{a}o
da influ\^{e}ncia de cada componente do sistema de suspens\~{a}o na resposta
din\^{a}mica do ve\'{i}culo completo.
...
e finalmente a percep\c{c}\~{a}o dos passageiros do comportamento do autom%
\'{o}vel.
...
motor e o conjunto rodas/pneus. A principal causa dessas excita\c{c}\~{o}es s%
\~{a}o as partes rotantes que produzem excita\c{c}\~{o}es din\^{a}micas
devido a desbalanceamento. Um rotor est\'{a} perfeitamente balanceado quando
o seu eixo de rota\c{c}\~{a}o coincide com um dos seus eixos principais de in%
\'{e}rcia, entretanto essa condi\c{c}\~{a}o \'{e} dif\'{i}cil de ser alcan%
...
a velocidades diferentes, dessa forma a freq\"{u}\^{e}ncia excitada por cada
...
sua pr\'{o}pria caracter\'{i}stica construtiva que apresenta varia\c{c}\~{o}%
es de espessura e rigidez ao longo da sua estrutura. (figura) Aliado a isso
...
inferiores as for\c{c}as de atrito do sistema de suspens\~{a}o. Se o autom%
\'{o}vel trafega em uma pista suficientemente lisa essa varia\c{c}\~{a}o de $%
Fz$ ser\'{a} percebida pelos ocupantes do ve\'{i}culo, j\'{a} que a for\c{c}%
a vertical que atua nos pneus n\~{a}o ser\'{a} suficiente para fazer a
suspens\~{a}o trabalhar, com isso toda a varia\c{c}\~{a}o de $Fz$ ser\'{a}
transmitida diretamente para os apoios da suspens\~{a}o na carroceria.
...
As varia\c{c}\~{o}es de rigidez do pneum\'{a}tico ao longo da sua circunfer%
\^{e}ncia resultam em for\c{c}as din\^{a}micas com freq\"{u}\^{e}ncias
iguais \`{a} freq\"{u}\^{e}ncia de rota\c{c}\~{a}o e seus m\'{u}ltiplos.

Os desvios dimensionais existentes na fabrica\c{c}\~{a}o das rodas e pneus n%
\~{a}o produzem grandes varia\c{c}\~{o}es de rigidez, por\'{e}m geram for%
\c{c}as e deslocamentos no eixo do ve\'{i}culo enquanto a roda gira. A
montagem pneu/roda \'{e} um sistema mec\^{a}nico complexo que filtra grande
uma parte das freq\"{u}\^{e}ncias produzidas na interface pneu/pista. As
altas freq\"{u}\^{e}ncias s\~{a}o filtradas primeiramente pelos pneus,
depois pelo sistema de suspens\~{a}o, e finalmente s\~{a}o percebidas a
bordo principalmente como ru\'{i}do e vibra\c{c}\~{o}es do interior (pain%
\'{e}is de porta, painel de instrumentos, tampas do porta-luvas, etc).
...
\c{c}\~{o}es de baixas freq\"{u}\^{e}ncias (1a 3 Hz), para essas freq\"{u}%
\^{e}ncias o pneu pode ser modelado como um corpo r\'{i}gido.
...
autom\'{o}veis de competi\c{c}\~{a}o (F1) etc....(Checar este coment\'{a}%
rio...)}

A freq\"{u}\^{e}ncias mais altas, acima de 50 Hz, os pneus vibram na sua freq%
\"{u}\^{e}ncia natural. Os pneus radias possuem freq\"{u}\^{e}ncias naturais
que variam de 60 a 90 Hz dependendo das suas dimens\~{o}es.\bigskip 

\subsection{Sistema de Transmiss\~{a}o}

As excita\c{c}\~{o}es oriundas do sistema de transmiss\~{a}o podem ter tr%
\^{e}s fontes diferentes, a caixa de c\^{a}mbio, o diferencial e o eixo de
...
\c{c}a da caixa de c\^{a}mbio. Dentre esses componentes o eixo de transmiss%
\~{a}o \'{e} o elemento que possui o maior potencial em \ gerar excita\c{c}%
\~{o}es de freq\"{u}\^{e}ncias at\'{e} 20 Hz. Em carros de passeio com tra%
\c{c}\~{a}o traseira ou tra\c{c}\~{a}o nas quatro rodas e em pequenos caminh%
\~{o}es utilizam-se um \'{u}nico eixo, enquanto em caminh\~{o}es maiores e 
\^{o}nibus o eixo de transmiss\~{a}o \'{e} montado utilizando v\'{a}rios
segmentos suportados por mancais de rolamento. As excita\c{c}\~{o}es
provenientes dos eixos podem ser geradas por dois fen\^{o}menos; um poss\'{i}%
vel desbalanceamento de massa do eixo, e os momentos secund\'{a}rios
provocados pelo \^{a}ngulo formado entre dois semi-eixos conectados por
juntas universais.
...
\~{a}o do torque devido \`{a} pulsa\c{c}\~{a}o do motor o momento secund\'{a}%
rio varia proporcionalmente. \'{E} importante notar que o \^{a}ngulo da
junta universal pode variar de acordo com condi\c{c}\~{a}o de carregamento
do ve\'{i}culo, onde geralmente o eixo de entrada move-se solid\'{a}rio \`{a}
carroceria e o eixo de sa\'{i}da move-se junto com o diferencial e conjunto
de suspens\~{a}o. Em alguns conceitos mais modernos o diferencial est\'{a}
solid\'{a}rio a um sub-chassi e essa varia\c{c}\~{a}o de \^{a}ngulo na junta
universal n\~{a}o ocorre ou \ \'{e} bastante reduzida.(figura)
...
considerados a principal fonte interna de vibra\c{c}\~{a}o e ru\'{i}do dos ve%
\'{i}culos. Essas vibra\c{c}\~{o}es tem uma freq\"{u}\^{e}ncia natural , em
motores de quatro cilindros, igual a metade da rota\c{c}\~{a}o do motor, mas
um grande n\'{u}mero de harm\^{o}nicos tamb\'{e}m est\'{a} presente.\cite
{Genta}
...
verticais provenientes das excita\c{c}\~{o}es das rodas. Para esse prop\'{o}%
sito\ o sistema de suporte do grupo moto-propulsor \'{e} projetado para ter
a freq\"{u}\^{e}ncia de resson\^{a}ncia vertical pr\'{o}xima da freq\"{u}%
\^{e}ncia de resson\^{a}ncia das rodas (wheel hope) 12-15 Hz, desta forma o
moto-propulsor pode atuar como um amortecedor de vibra\c{c}\~{o}es para esse
modo de vibra\c{c}\~{a}o do ve\'{i}culo.\cite{Gillespie}\FRAME{fhFU}{2.808in%
}{1.8481in}{0pt}{\Qcb{Coxin e suporte do motor.}}{}{motor_suport.jpg}{%
\special{language "Scientific Word";type "GRAPHIC";maintain-aspect-ratio
...
perfil da superf\'{i}cie varia de forma aleat\'{o}ria tanto na dire\c{c}\~{a}%
o longitudinal como na transversal. O perfil de pista, por suas varia\c{c}%
\~{o}es de eleva\c{c}\~{a}o aleat\'{o}rias, pode ser inclu\'{i}do,
...
comportamento caracter\'{i}stico de queda da amplitude com o aumento do n%
\'{u}mero de onda nos mostra que o conceito de propriedades m\'{e}dias para
...
Os modelos, usualmente, utilizam a combina\c{c}\~{a}o de uma seq\"{u}\^{e}%
ncia de n\'{u}meros aleat\'{o}rios e uma curva aproximada por polin\^{o}mios
\cite{Sayers01},\cite{Gillespie}, \cite{Montiglio}, \cite{Genta}, \cite
{ElBeheiry and Karnopp}, \cite{X.P.Lu}, \cite{Dodds} embora existam
propostas que se baseiam na obten\c{c}\~{a}o da PSD utilizando uma fun\c{c}%
\~{a}o exponencial \cite{Tamboli and Joshi} e \cite{Kozin}.

Na literatura especializada encontram-se normalmente duas formas anal\'{i}%
ticas distintas para a constru\c{c}\~{a}o matem\'{a}tica de uma PSD
...
tem-se que a PSD temporal de uma pista, pode ser definida pela equa\c{c}\~{a}%
o seguinte.
...
\FRAME{fhF}{5.7545in}{2.5408in}{0pt}{}{}{psd02hz.jpg}{\special{language
"Scientific Word";type "GRAPHIC";maintain-aspect-ratio TRUE;display
"USEDEF";valid_file "F";width 5.7545in;height 2.5408in;depth
...
o aumento da freq\"{u}\^{e}ncia. Esse comportamento mostra que a altas freq%
\"{u}\^{e}ncias as irregularidades da pista ser\~{a}o sentidas
...
no sentido do aumento das amplitudes do deslocamento, velocidade e acelera%
\c{c}\~{a}o.
...
mais baixa que a resson\^{a}ncia em ''bounce'', por\'{e}m, para baixas freq%
\"{u}\^{e}ncias a magnitude da excita\c{c}\~{a}o do modo de ''roll'' e
inferior \`{a} excita\c{c}\~{a}o dos modos de ''bounce'' e ''pitch''. J\'{a}
nas freq\"{u}\^{e}ncias mais altas quando as magnitudes das excita\c{c}\~{o}%
es dos modos de ''roll'' e ''bounce'' s\~{a}o da mesma ordem de grandeza os
...
Um ve\'{i}culo n\~{a}o responde da mesma forma a todas as faixas de freq\"{u}%
\^{e}ncia das excita\c{c}\~{o}es a que ele est\'{a} sujeito, ao contr\'{a}%
rio, ele amplifica ou atenua as excita\c{c}\~{o}es provenientes das fontes
de excita\c{c}\~{a}o de forma diferente para cada faixa de freq\"{u}\^{e}%
ncia.
...
prot\'{o}tipo. Os modelos matem\'{a}ticos auxiliam aos projetitas desde o in%
\'{i}cio do desenvolvimento de um autom\'{o}vel at\'{e} nos \'{u}ltimos
...
definem um modelo matem\'{a}tico para o estudo do conforto de um autom\'{o}%
vel, s\~{a}o elas:
...
1/4 de ve\'{i}culo e os modos de ''bounce'' e ''pitch'' no modelo de meio ve%
\'{i}culo.
...
O modelo de 1/4 de ve\'{i}culo apesar de ser um modelo bastante simples \'{e}
de extrema import\^{a}ncia para compreender alguns fen\^{o}menos da resposta
do autom\'{o}vel as fontes de excita\c{c}\~{a}o a que ele est\'{a} sujeito.
...
\bigskip Observa-se que a baixas freq\"{u}\^{e}ncias o ganho \'{e} unit\'{a}%
rio o que mostra que as massas suspensas e n\~{a}o suspensas tem amplitude
de deslocamento exatamente igual \`{a} da pista, o autom\'{o}vel ''copia''
exatamente o perfil da pista.

A freq\"{u}\^{e}ncias pr\'{o}ximas de $1Hz$ a massa suspensa entra em resson%
\^{a}ncia, o que corresponde ao primeiro modo de vibrar do sistema de 2
graus de liberdade, em torno dessa freq\"{u}\^{e}ncia as irregularidades da
...
O segundo pico na curva de resposta da massa suspensa \'{e} devido a resson%
\^{a}ncia da massa n\~{a}o suspensa que ocorre na faixa de freq\"{u}\^{e}%
ncia entre $10$ e$12Hz$, o que corresponde ao segundo modo de vibrar do
sistema. Pode-se observar no gr\'{a}fico \ref{receptance00} \ que a ocorr%
\^{e}ncia do segundo pico na curva de resposta da massa suspensa corresponde
ao maior ganho da curva da massa n\~{a}o suspensa. O mesmo ocorre para a
curva da massa n\~{a}o suspensa pr\'{o}ximo a freq\"{u}\^{e}ncia de $1Hz$.
...
deslocamento, equa\c{c}\~{a}o\ref{14veiculoequa04}, por $\varpi ^{2}$, j\'{a}
que a resposta e a excita\c{c}\~{a}o do sistema s\~{a}o considerados harm%
\^{o}nicos para a solu\c{c}\~{a}o do sistema. Desta forma a resposta em freq%
\"{u}\^{e}ncia da acelera\c{c}\~{a}o da carroceria, caracterizada pela raz%
\~{a}o entre a acelera\c{c}\~{a}o da carroceria e a acelera\c{c}\~{a}o
...
massa suspensa. Obtem-se dessa forma a raz\~{a}o entre a amplitude da for%
\c{c}a necess\'{a}ria para produzir as acelera\c{c}\~{o}es a que est\'{a}
...
responde com ganho aproximadamente igual a 1 o que mostra que para freq\"{u}%
\^{e}ncias acima de $1Hz$ o ve\'{i}culo possui uma alta sensibilidade a
excita\c{c}\~{o}es atuantes diretamente na carroceria, pois os deslocamentos
produzidos pelas for\c{c}as s\~{a}o t\~{a}o pequenos que o sistema de suspens%
\~{a}o n\~{a}o \'{e} mais capaz de absorv\^{e}-los e a for\c{c}a \'{e} quase
toda dissipada em acelera\c{c}\~{o}es da massa suspensa\cite{Gillespie}.

A segunda curva mostra a resposta da carroceria \`{a} excita\c{c}\~{o}es
provenientes da massa n\~{a}o suspensa. Para valores de freq\"{u}\^{e}ncia pr%
\'{o}ximos de zero o ganho da carroceria \'{e} igual a zero, pois as for\c{c}%
as na suspens\~{a}o s\~{a}o absorvidas pela rigidez dos pneus. O\ ganho
...
Considerando que normalmente $Kp$ \'{e} muito maior que $Ks$ tem-se que a raz%
\~{a}o; 
\begin{equation}
...
\bigskip O segundo pico apresentado no gr\'{a}fico \ref{receptance01}, est%
\'{a} relacionado com o segundo modo de vibrar do sistema; esse modo
...
amortecimento faz com que o ganho aumente, o mesmo acontece para a regi\~{a}%
o \`{a} direita do ponto D.

Normalmente, segundo Jolly\cite{Jolly}, os coeficientes de amortecimento cr%
\'{i}tico para a resson\^{a}ncia da carroceria e da massa n\~{a}o suspensa s%
\~{a}o muito pr\'{o}ximos. Dessa forma, o coeficiente de amortecimento $Cs$,
que \'{e} adotado para os ajustes visando conforto vibracional visando
reduzir a resposta vertical da carroceria na freq\"{u}\^{e}ncia de resson%
\^{a}ncia tamb\'{e}m ser\'{a} eficiente no amortecimento na resson\^{a}ncia
vertical da massa n\~{a}o suspensa. Por outro lado, esse amortecimento ter%
\'{a} um efeito adverso na faixa de freq\"{u}\^{e}ncia entre 3 e 10 Hz, que
abrange uma grande faixa no interesse do estudo do conforto de autom\'{o}%
veis e na faixa acima de 12 Hz.
...
isso faz com a rigidez da suspens\~{a}o seja a principal determinante da freq%
\"{u}\^{e}ncia do modo de ''bounce'' do autom\'{o}vel. Para se obter um bom
...
um autom\'{o}vel, a resposta foi obtida utilizando um modelo de 1/4 de ve%
\'{i}culo semelhante ao da figura \ref{14veiculo}.
...
aproximadamente $22m/s^{2}$. Nota-se que a freq\"{u}\^{e}ncia de resson\^{a}%
ncia aumenta a medida que o valor de $Ks$ aumenta e a amplifica\c{c}\~{a}o
das acelera\c{c}\~{o}es alcan\c{c}a o valor de aproximadamente $25m/s^{2}$%
para $Ks=16000N/m$.
...
Segundo Gillespie \cite{Gillespie}, como \'{e} mais f\'{a}cil isolar vibra%
\c{c}\~{o}es de alta freq\"{u}\^{e}ncia em qualquer parte do chassis, a
menor massa n\~{a}o suspensa produzir\'{a}, geralmente, melhor comportamento
do autom\'{o}vel em conforto ( ''Ride'').
...
importantes. Segundo Gillespie \cite{Gillespie} os movimentos de ''pitch'' s%
\~{a}o importantes pois geralmente s\~{a}o considerados desagrad\'{a}veis e s%
\~{a}o as fontes b\'{a}sicas de vibra\c{c}\~{o}es longitudinais em pontos
...
Para o estudo dos modos e freq\"{u}\^{e}ncias de ''pitch'' e ''bounce'' \'{e}
...
de equa\c{c}\~{o}es \ref{12veiculo02}, obtem-se as seguintes freq\"{u}\^{e}%
ncias naturais.
...
\bigskip Os par\^{a}metros sugeridos por Maurice Olley, que datam da d\'{e}%
cada de 30, para o projeto de autom\'{o}veis com boas caracter\'{i}sticas de
''ride'' n\~{a}o poderiam deixar de ser citados. Segundo Gillespie \cite
{Gillespie} , embora os m\'{e}todos utilizados para determinar o n\'{i}vel
conforto do autom\'{o}vel utilizado nos experimentos tenham sido
estrictamente subjetivos, as recomenda\c{c}\~{o}es de Olley ainda hoje s\~{a}%
o utilizadas nos projetos de autom\'{o}veis. Os crit\'{e}rios de Olley s\~{a}%
o:\footnote{%
...
pitch s\~{a}o considerados mais desagrad\'{a}veis que os de bounce, \'{e} at%
\'{e} intuitivo concluir porque a primeira recomenda\c{c}\~{a}o de Olley 
...
2)As freq\"{u}\^{e}ncias de ''pitch e bounce'' devem ser pr\'{o}ximas: a freq%
\"{u}\^{e}ncia de ''bounce'' deve ser menor que $1,2$ vezes a freq\"{u}\^{e}%
ncia de ''pitch''.
...
aparecer se a freq\"{u}\^{e}ncia de ''pitch'' for muito maior que a freq\"{u}%
\^{e}ncia de ''bounce'', como pode acontecer quando o \'{I}ndice din\^{a}%
mico for menor que 1 (geralmente ocorre em ve\'{i}culos com grandes dist\^{a}%
ncias entre eixos e com as rodas bem pr\'{o}ximas dos extremos da carroceria)
...
\~{a}o do conforto de um autom\'{o}vel passa por um conjunto de par\^{a}%
metros t\'{a}cteis, visuais e aud\'{i}veis. Par\^{a}metros esses que muitas
vezes n\~{a}o se percebem separadamente e que se separados talvez n\~{a}o
causem desconforto, ou n\~{a}o produzam o mesma sensa\c{c}\~{a}o agrad\'{a}%
vel.
...
A toler\^{a}ncia a determinadas formas, e dire\c{c}\~{o}es de vibra\c{c}\~{o}%
es tamb\'{e}m est\~{a}o relacionadas a posi\c{c}\~{a}o do corpo (em p\'{e},
sentado ou deitado), a parte do corpo que recebe a vibra\c{c}\~{a}o e a v%
\'{a}rios outros par\^{a}metros. De acordo com Griffin \cite{Griffin}, a
postura de uma pessoa sentada ou em p\'{e} pode determinar grandes mudan\c{c}%
as na toler\^{a}ncia a vibra\c{c}\~{o}es, uma pequena mudan\c{c}a na orienta%
\c{c}\~{a}o das costas ou na inclina\c{c}\~{a}o da cabe\c{c}a pode causar
mudan\c{c}as substanciais nas vibra\c{c}\~{o}es transmitidas atrav\'{e}s da
coluna para a cabe\c{c}a.
...
propriedades din\^{a}micas diferentes estabeleceu-se que \'{e} prefer\'{i}%
vel a utiliza\c{c}\~{a}o de bancos r\'{i}gidos sem encosto para a determina%
\c{c}\~{a}o experimental dos contornos do conforto vibracional.\cite{Griffin}
Em outros casos recomenda-se fazer a medi\c{c}\~{a}o pr\'{o}ximo da fixa\c{c}%
\~{a}o do banco ao assoalho e utilizar a transmissibilidade do banco para
avaliar a vibra\c{c}\~{a}o que poderia estar chegando ao ocupante do ve\'{i}%
culo, embora esse procedimento n\~{a}o leve em considera\c{c}\~{a}o a itera%
\c{c}\~{a}o entre a resposta do banco e do passageiro, j\'{a} que o
...
com o movimento da fonte de vibra\c{c}\~{a}o. Com o aumento da freq\"{u}\^{e}%
ncia de excita\c{c}\~{a}o o desconforto ficar\'{a} caracterizado pela resson%
\^{a}ncia de diferentes partes do corpo (abd\^{o}men, cabe\c{c}a, ombros, t%
\'{o}rax, etc.).
...
\\ \hline
\textit{Wheelhop} (Diant. em fase) & $10,341Hz$ & $10,713Hz$ & $11,189Hz$ & $%
11,777Hz$ & $12,483Hz$ \\ \hline
\textit{Wheelhop} (Diant. fora de fase) & $10,839Hz$ & $11,174Hz$ & $%
11,599Hz $ & $12,124Hz$ & $12,756Hz$ \\ \hline
\textit{Wheelhop} (Tras. em fase) & $11,012Hz$ & $11,019Hz$ & $11,025Hz$ & $%
11,030Hz$ & $11,034Hz$ \\ \hline
\textit{Wheelhop} (Tras. fora de fase) & $38,692Hz$ & $38,723Hz$ & $38,748Hz$
& $38,768Hz$ & $38,783Hz$ \\ \hline\hline
\end{tabular}
\label{ResultsModos}
\end{equation}
...
\section{\protect\bigskip Resposta em Frequ\^{e}ncia da Carroceira}
...
'GKUVDF00.wmf';tempfile-properties "XPR";}}
...
trafegando por uma estrada de asfalto irregular a $40km/h$.\bigskip
...
"1";cropright "1";cropbottom "0";tempfilename
'GKUVDF02.wmf';tempfile-properties "XPR";}}
...
"0";tempfilename 'GKUVDF04.wmf';tempfile-properties "XPR";}}
...
"0";tempfilename 'GKUVDF05.wmf';tempfile-properties "XPR";}}A barra
...
"1";cropbottom "0";tempfilename 'GKUVDF06.wmf';tempfile-properties "XPR";}}
...
"1";cropright "1";cropbottom "0";tempfilename
'GKUVDF07.wmf';tempfile-properties "XPR";}}
...
"1";cropbottom "0";tempfilename 'GKUVDF08.wmf';tempfile-properties "XPR";}}
...
"1";cropbottom "0";tempfilename 'GKUVDF09.wmf';tempfile-properties "XPR";}}
...
\bigskip A an\'{a}lise de sensibilidade apresenta uma boa forma de mensurar
a influ\^{e}ncia da altera\c{c}\~{a}o da rigidez da barra estabilizadora na
...
frequ\^{e}ncias\ dos modos da carroceria\bigskip , as acelera\c{c}\~{o}es
verticais da carroceria mostraram-se mais sucept\'{i}veis \`{a}s mudan\c{c}%
as na rigidez da barra estabilizadora do que nas demais faixas de
frequ\^{e}ncia. Dentro dessa faixa pode-se \ verificar que para a barra com
di\^{a}metro de $22mm$ o modelo se mostrou mais sens\'{i}vel \`{a}s vari\c{c}%
\~{o}es do di\^{a}metro da barra estabilizadora, tanto para a sensibilidade
calculada entre os picos da PSD como para o RMS da acelera\c{c}\~{a}o
vertical da carroceira.
...
\bigskip\ \FRAME{fbhFU}{390pt}{237.625pt}{0pt}{\Qcb{Valores de RMS
utilizados para o c\'{a}lculo da sensibilidade para os cinco di\^{a}metros
da barra estabilizadora.}}{\Qlb{rms_sensive}}{Figure }{\special{language
"Scientific Word";type "GRAPHIC";maintain-aspect-ratio TRUE;display
"USEDEF";valid_file "T";width 390pt;height 237.625pt;depth
0pt;original-width 585.0625pt;original-height 355.625pt;cropleft "0";croptop
"1";cropright "1";cropbottom "0";tempfilename
'GKUVDF0A.wmf';tempfile-properties "XPR";}}

\bigskip \FRAME{fhFU}{388.1875pt}{262.75pt}{0pt}{\Qcb{Valores de PSD
utilizados para o c\'{a}lculo da sensibilidade para os cinco di\^{a}metros
da barra estabilizadora.}}{\Qlb{PSD_sensive}}{Figure }{\special{language
"Scientific Word";type "GRAPHIC";maintain-aspect-ratio TRUE;display
"USEDEF";valid_file "T";width 388.1875pt;height 262.75pt;depth
0pt;original-width 526.375pt;original-height 355.625pt;cropleft "0";croptop
"1";cropright "1";cropbottom "0";tempfilename
'GKUVDF0B.wmf';tempfile-properties "XPR";}}

\bigskip

\chapter{Conclus\~{o}es}

\bigskip Neste trabalho foi apresentado um estudo sobre a influ\^{e}ncia da
varia\c{c}\~{a}o da rigidez da barra estabilizadora dianteira nas vibra\c{c}%
\~{o}es verticais da carroceria de um ve\'{i}culo causadas pelas
irregularidades da pista por onde este trafega.
...
carroceria puderam ser bem representados pelo modelo, e mostrando boa
...
carroceira causada pela alter\c{c}\~{a}o do deslocamento do centro da roda
...
modelagem por multiplos corpos e o grau de refinamento a que se pode chegar
em an\'{a}lises de sistemas din\^{a}micos complexos. Com os modelos de
ve\'{i}culo e pistas \ bem\ ajustados a resultados experimentais, \'{e}
...
outros par\^{a}metros que se julgarmem necess\'{a}rios para a avalia\c{c}%
...
Gerais utilizando a modelagem por multiplos corpos e o software
ADAMS\registered , e pretendente servir de base e incentivo para o
desenvolvimento de novos trabalhos na \'{a}rea de din\^{a}mica veicular e de
sistemas mec\^{a}nicos em geral.

Como sugest\~{a}o para trabalhos futuros pode-se sugerir um ajustes de
par\^{a}metros para o modelo desenvolvido atrav\'{e}s da compara\c{c}\~{a}o
dos resultados obtidos com resultados de experimentos. A implementa\c{c}%
\~{a}o de modelos de pneus que permitam estudos de dirigibilidade (\textit{%
Handling}) e a inclus\~{a}o de um sistema de controle da rigidez da barra
estabilizadora\cite{Darling} utilizando a integra\c{c}\~{a}o entre os
softwares ADAMS\registered\ e MATLAB\registered \cite{Silva}. A inclus\~{a}o
no modelo de elementos el\'{a}sticos nas fixa\c{c}\~{o}es do sistema de
suspens\~{a}o (buchas) e um estudo da sua influ\^{e}ncia nas acelera\c{c}%
\~{o}es da carroceira e das for\c{c}as atuantes nas fixa\c{c}\~{o}es das
barras estabilizadoras\cite{Spring Manual}.Um estudo para a modifica\c{c}%
\~{a}o do sistema de fixa\c{c}\~{a}o da barra estabilizadora dianteira \`{a}
suspens\~{a}o de forma a minimizar os efeitos da flex\~{a}o da barra e
consequentemente a transmiss\~{a}o de esfor\c{c}os para os mancais na
carroceira.
