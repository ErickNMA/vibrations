...
%TCIDATA{LastRevised=Thu Aug 02 15:48:11 2001}
...
\section{ A Suspens\~{a}o McPherson}
...
\section{A suspens\~{a}o Semi-Trailing Arm}
...
\FRAME{fhFU}{3.3831in}{2.7095in}{0pt}{\Qcb{R.m.s da acelera\c{c}\~{a}o em
...
"GRAPHIC";maintain-aspect-ratio TRUE;display "USEDEF";valid_file "F";width
3.3831in;height 2.7095in;depth 0pt;original-width 8.3333in;original-height
6.6668in;cropleft "0";croptop "1";cropright "1";cropbottom "0";filename
...
%
%EndExpansion
Precede the first appendix with the indent latex fragment included here.
Otherwise, there is a bug which keeps text from indenting properly.

Use regular sections and subsections (or subsectionNoContents) in
appendices.\newpage
